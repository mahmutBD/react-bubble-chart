...
var ReactBubbleChartD3 = (function () {
  ...
  _createClass(ReactBubbleChartD3, [{
    ...
    value: function update(el, props) {
      ...
      console.log(d);
      labels.innerHTML(d.value).on('mouseover', this._tooltipMouseOver.bind(this, color, el)).transition().duration(duration).delay(function (d, i) {
        return i * delay;
        ...
        return d.y - d.r + 'px';
      }).style('opacity', 1).style('background-color', function (d) {
        return d.selected ? _this2.selectedColor : color(d.colorValue);
